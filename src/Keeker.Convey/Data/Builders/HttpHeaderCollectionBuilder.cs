...
namespace Keeker.Convey.Data.Builders
{
    public class HttpHeaderCollectionBuilder
    {
        ...
        {
            this.Headers = new List<Convey.Data.Builders.HttpHeaderBuilder>();
        }

        public HttpHeaderCollectionBuilder(HttpHeaderCollection headers)
        {
            this.Headers = headers
                .Select(x => new Convey.Data.Builders.HttpHeaderBuilder(x))
                .ToList();
        }
        ...
        public List<Convey.Data.Builders.HttpHeaderBuilder> Headers { get; }
